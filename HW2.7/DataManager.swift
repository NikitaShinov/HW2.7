...
//
let firstNames = ["Joe", "Barack", "Donald", "George", "Bill",
                  "Ronald", "Jimmy", "Gerald", "Richard", "Lyndon"]
let lastNames = ["Biden", "Obama", "Trump", "Bush", "Clinton",
                 "Reagan", "Carter", "Ford", "Nixon", "Johnson"]
let emails = ["bbbb@gov.com", "oooo@gov.com", "tttt@gov.com", "gggg@gov.com", "cccc@gov.com",
